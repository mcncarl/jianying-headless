...
# Independently read from reviewed binaries' LC_BUILD_VERSION and local ld.
# Compiler, SDK and linker identities are supplied by the selected runtime
# profile so multiple exact toolchains can coexist without a loose fallback.
